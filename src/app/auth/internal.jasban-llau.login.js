...
const TITLE = 'LOGIN - JASBAN LLAU';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_LLAU;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-jasban-llau/login`;
const REDIRECT_SUCCESS = '/internal_content/jasban-llau';
