...
const TITLE = 'LOGIN - JASBAN PNBP';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_PNBP;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-jasban-pnbp/login`;
const REDIRECT_SUCCESS = '/internal_content/jasban-pnbp';
