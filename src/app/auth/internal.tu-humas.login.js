...
const TITLE = 'LOGIN - TU HUMAS';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_HUMAS;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-tu-humas/login`;
const REDIRECT_SUCCESS = '/internal_content/tu-humas';
