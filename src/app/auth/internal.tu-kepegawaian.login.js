...
const TITLE = 'LOGIN - TU KEPEGAWAIAN';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_TU_KEPEG;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-tu-kepeg/login`;
const REDIRECT_SUCCESS = '/internal_content/tu-kepegawaian';
