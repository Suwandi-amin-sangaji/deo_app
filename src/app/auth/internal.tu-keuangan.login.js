...
const TITLE = 'LOGIN - TU KEUANGAN';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_KEUANGAN;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-tu-keuangan/login`;
const REDIRECT_SUCCESS = '/internal_content/tu-keuangan';
