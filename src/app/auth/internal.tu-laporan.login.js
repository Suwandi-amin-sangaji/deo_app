...
const TITLE = 'LOGIN - TU TATA LAPORAN';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_TATA_LAPORAN;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-tu-laporan/login`;
const REDIRECT_SUCCESS = '/internal_content/tu-laporan';
