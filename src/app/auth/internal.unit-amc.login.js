...
const TITLE = 'LOGIN - UNIT AMC';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_AMC;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-amc/login`;
const REDIRECT_SUCCESS = '/internal_content/unit-amc';
