...
const TITLE = 'LOGIN - UNIT BANGLAND';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_BANGLAND;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-bangland/login`;
const REDIRECT_SUCCESS = '/internal_content/unit-bangland';
