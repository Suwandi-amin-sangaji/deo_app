...
const TITLE = 'LOGIN - UNIT ELBAN';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_ELBAN;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-elban/login`;
const REDIRECT_SUCCESS = '/internal_content/unit-elban';
