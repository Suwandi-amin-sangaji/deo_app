...
const TITLE = 'LOGIN - UNIT PKP-PK';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_PKP_PK;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-pk/login`;
const REDIRECT_SUCCESS = '/internal_content/unit-pk';
