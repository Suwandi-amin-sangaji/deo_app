...
const TITLE = 'LOGIN - DPPU PERTAMINA';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MITRA_ACCOUNT_DPPU_PERTAMINA;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/mitra-dppu-pertamina/login`;
const REDIRECT_SUCCESS = '/mitra-content/dppu-pertamina';
