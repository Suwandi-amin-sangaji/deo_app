...
const TITLE = 'LOGIN - GROUND HANDLING';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MITRA_ACCOUNT_GROUND_HANDLING;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/mitra-ground-handling/login`;
const REDIRECT_SUCCESS = '/mitra-content/ground-handling';
