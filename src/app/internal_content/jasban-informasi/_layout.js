...
const TITLE  = 'JASBAN - INFORMASI';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_INFORMASI;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-jasban-informasi`;
const REDIRECT_LOGIN = '/auth/internal.jasban-informasi.login';
const BASEPATH = '/internal_content/jasban-informasi';
