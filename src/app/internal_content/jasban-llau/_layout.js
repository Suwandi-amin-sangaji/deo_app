...
const TITLE  = 'JASBAN - LLAU';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_LLAU;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-jasban-llau`;
const REDIRECT_LOGIN = '/auth/internal.jasban-llau.login';
const BASEPATH = '/internal_content/jasban-llau';
