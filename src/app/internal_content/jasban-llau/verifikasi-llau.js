...
export default () => {
  ...
  const [parentFilter, setParentFilter] = useState([
    ...
    {is_verified_operator : { $eq : true}},
    {is_verified_llau : { $eq : null}},
...
const Final = memo(({ setViewMode, title, baseApiUrl, user, reloadData = () => { }, itemFocus, setItemFocus }) => {
  ...
  const populateForm = {
    is_verified_llau : true
  };

  const custom_fields = {
    catatan_final: {
      label: 'CATATAN UNTUK PETUGAS PNBP',
      type: "text"
    },
  };
...
const Cancel = memo(({ setViewMode, title, baseApiUrl, user, reloadData = () => { }, itemFocus, setItemFocus }) => {
  ...
  const populateForm = {
    is_verified_operator : null,
    operator_verified_Date : null
  };

  const custom_fields = {
    catatan_perbaikan_operator: {
      label: 'CATATAN PERBAIKAN UNTUK OPERATOR',
      type: "text"
    },
  };
