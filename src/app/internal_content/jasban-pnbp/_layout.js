...
const TITLE  = 'JASBAN - PNBP';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_PNBP;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-jasban-pnbp`;
const REDIRECT_LOGIN = '/auth/internal.jasban-pnbp.login';
const BASEPATH = '/internal_content/jasban-pnbp';
