...
const TITLE  = 'TU - HUMAS';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_HUMAS;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-tu-humas`;
const REDIRECT_LOGIN = '/auth/internal.tu-humas.login';
const BASEPATH = '/internal_content/tu-humas';
