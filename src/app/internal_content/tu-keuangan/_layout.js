...
const TITLE  = 'TU - KEUANGAN';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_KEUANGAN;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-tu-keuangan`;
const REDIRECT_LOGIN = '/auth/internal.tu-keuangan.login';
const BASEPATH = '/internal_content/tu-keuangan';
