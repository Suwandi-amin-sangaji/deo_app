...
const TITLE  = 'TU - LAPORAN';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_TATA_LAPORAN;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-tu-laporan`;
const REDIRECT_LOGIN = '/auth/internal.tu-laporan.login';
const BASEPATH = '/internal_content/tu-laporan';
