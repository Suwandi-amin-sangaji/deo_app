...
const TITLE  = 'UNIT A2B';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_A2B;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-albes`;
const REDIRECT_LOGIN = '/auth/internal.unit-a2b.login';
const BASEPATH = '/internal_content/unit-a2b';
