...
const TITLE  = 'UNIT AMC';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_AMC;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-amc`;
const REDIRECT_LOGIN = '/auth/internal.unit-amc.login';
const BASEPATH = '/internal_content/unit-amc';
