...
const TITLE = 'UNIT AVSEC';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_AVSEC;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-avsec`;
const REDIRECT_LOGIN = '/auth/internal.unit-avsec.login';
const BASEPATH = '/internal_content/unit-avsec';
