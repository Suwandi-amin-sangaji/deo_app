...
const TITLE  = 'UNIT BANGLAND';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_BANGLAND;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-bangland`;
const REDIRECT_LOGIN = '/auth/internal.unit-bangland.login';
const BASEPATH = '/internal_content/unit-bangland';
