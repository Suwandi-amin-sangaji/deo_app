...
const TITLE  = 'UNIT ELBAN';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_ELBAN;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-elban`;
const REDIRECT_LOGIN = '/auth/internal.unit-elban.login';
const BASEPATH = '/internal_content/unit-elban';
