...
const TITLE  = 'UNIT LISTRIK';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_LISTRIK;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-listrik`;
const REDIRECT_LOGIN = '/auth/internal.unit-listrik.login';
const BASEPATH = '/internal_content/unit-listrik';
