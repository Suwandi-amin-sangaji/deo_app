...
const TITLE  = 'UNIT PK';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MEMBER_ACCOUNT_INTERNAL_PKP_PK;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/internal-unit-pk`;
const REDIRECT_LOGIN = '/auth/internal.unit-pk.login';
const BASEPATH = '/internal_content/unit-pk';
