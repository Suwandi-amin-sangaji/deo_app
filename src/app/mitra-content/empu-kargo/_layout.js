...
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/mitra-empu-kargo`;
const REDIRECT_LOGIN = '/auth/mitra.empu-kargo.login';
const BASEPATH = '/mitra-content/empu-kargo';
