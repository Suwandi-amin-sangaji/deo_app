...
const TITLE  = 'GROUND HANDLING';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MITRA_ACCOUNT_GROUND_HANDLING;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/mitra-ground-handling`;
const REDIRECT_LOGIN = '/auth/mitra.ground-handling.login';
const BASEPATH = '/mitra-content/ground-handling';
