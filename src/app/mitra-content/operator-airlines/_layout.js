...
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/mitra-operator-airlines`;
const REDIRECT_LOGIN = '/auth/mitra.operator-airlines.login';
const BASEPATH = '/mitra-content/operator-airlines';
