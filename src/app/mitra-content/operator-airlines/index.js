...
export default () => {
  ...
  const url = 'https://editor.deoairport.co.id/mobile/apps/android_operator_airlines/home';
...
export default () => {
  ...
  const menu = [

    {
      ...
      listMenu: [
        {
          title: 'VERIFIKASI DATA ANGUD',
          href: '/data-amc-unverified',
          icon: { component: FontAwesome, name: 'fire-extinguisher' }
        },
        {
          title: 'LOG DATA ANGKUTAN UDARA',
          href: '/log-angud',
          icon: { component: MaterialIcons, name: 'security' }
        },
        {
          title: 'LOG DATA CSD SECURITY',
          href: '/log-csd',
          icon: { component: MaterialIcons, name: 'security' }
        },
      ]
    ...
    {
      title: 'INTEGRASI DATA TAGIHAN',
      basepath: basepath,
      base_color: '#be123c',
      listMenu: [
        {
          title: 'NOTA TAGIHAN - BELUM TERBAYAR',
          href: '/nota-tagihan-belum-bayar',
          icon: { component: FontAwesome, name: 'fire-extinguisher' }
        },
        {
          title: 'NOTA TAGIHAN - TERLAMBAT',
          href: '/nota-tagihan-denda',
          icon: { component: FontAwesome, name: 'fire-extinguisher' }
        },
        {
          title: 'NOTA TAGIHAN - SUDAH TERBAYAR',
          href: '/nota-tagihan-terbayar',
          icon: { component: MaterialIcons, name: 'security' }
        },
      ]
    },
    {
      title: 'INTEGRASI DATA AKSES',
      basepath: basepath,
      base_color: '#be123c',
      listMenu: [
        {
  ...
  return (<SafeAreaLayout style={{ flex: 1 }} insets='top'>
    ...
    <View className=" flex-row items-center justify-between p-2">
      ...
      <View className=" flex-col items-center justify-center">
        <Text className=" text-md font-bold">HOME - {user.data_op_airline ? user.data_op_airline.name : title}</Text>
      </View>
