...
const TITLE  = 'TENANT BANDARA';
const INTERNAL_DATA_NAME = process.env.EXPO_PUBLIC_ASYNC_MITRA_ACCOUNT_TENANT_BANDARA;
const BACKEND_LOGIN_URL = `${process.env.EXPO_PUBLIC_BACKEND_URL}/mitra-tenant-bandara`;
const REDIRECT_LOGIN = '/auth/mitra.tenant-bandara.login';
const BASEPATH = '/mitra-content/tenant-bandara';
